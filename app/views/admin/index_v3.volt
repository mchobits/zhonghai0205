...
<div class="wrapper wrapper-content">
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-info pull-right">男性</span>
                    <h5>参与活动用户数</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">{{ manTotalMember}}</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-danger pull-right">女性</span>
                    <h5>参与活动用户数</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">{{girlTotalMember }}</h1>
