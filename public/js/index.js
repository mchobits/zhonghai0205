...
function dh3() {
	setTimeout(function() {
		rotateScale("a3002", 0, 300, 0, 400, 1, 1, 0, 0, 0, 1, 500, 300, 0, 1);
		rotateScale("a3003", 0, 700, 0, 600, 1, 1, 0, 0, 0, 1, 500, 600, 0, 1);
...
function dh31() {
	$("#timu3").fadeOut(500);
	justOpacity("a3006", 0, 1, 1000, 300, 4);
	justOpacity("a3007", 0, 1, 1000, 600, 4);
	rotateScale("a3009", 450, 500, 450, 500, 0, 1, 0, 0, 0, 1, 600, 800, 0, 1);
...
function dh2() {
	...
	setTimeout(function() {
		$("#timu2").fadeIn(500);
		rotateScale("a1008a", 40, 50, 40, 50, 0, 1, 0, 0, 0, 1, 500, 500, 0, 1);
		rotateScale("a1009a", 40, 410, 40, 410, 0, 1, 0, 0, 0, 1, 500, 1000, 0, 1);
		rotateScale("a1010a", 40, 810, 40, 810, 0, 1, 0, 0, 0, 1, 500, 1500, 0, 1);
	}, 3500);
...
function dha11() {
    ...
    justOpacity("a1016", 0, 1, 500, 500, 4);
    $('#a1014').attr("class", "yy");
    $('#a1015').attr("class", "yy");
...
function dha12() {
    ...
    $('#a1004').fadeOut(500);
    $('#a1011').fadeOut(500);
    justOpacity("a1018", 0, 1, 500, 600, 4);
    $('#a1022').attr("class", "yy");
...
function dha13() {
    ...
    $('#a1011').fadeOut(500);
	$('#a1027').attr("class", "yy");
    justOpacity("a1013", 0, 1, 500, 500, 4);
