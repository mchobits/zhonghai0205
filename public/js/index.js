...
function dh23() {
    ...
    setTimeout(function () {
        $("#a2002b").fadeOut(1000);
        justOpacity("a2036", 0, 1, 200, 500, 4);
    }, 1500);

    justOpacity("a2039", 0, 1, 1000, 1500, 4);
    justOpacity("a2037", 0, 1, 2000, 2500, 4);

    rotateScale("a2038", 500, 1200, 500, 570, 1, 1, 0, 0, 0, 1, 3000, 800, 0, 4);
...
function dh21() {
	...
	$("#a2002").fadeOut(200);
    $("#a2002b").fadeOut(200);
    justOpacity("a2004", 0, 1, 200, 200, 4);
    justOpacity("a2005", 0, 1, 200, 200, 4);
